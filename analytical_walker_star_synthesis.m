% ANALYTICAL_WALKER_STAR_SYNTHESIS  Press Run for the closed-form Walker-Star sizing.
%
%   Main entry point for the *analytical* constellation synthesis. Sweeps a
%   range of altitudes and, for each one, computes the minimal Walker-Star
%   constellation (planes / sats-per-plane / total) needed to guarantee
%   coverage above a minimum latitude at a minimum elevation angle, using a
%   closed-form street-of-coverage model (no Monte-Carlo).
%
%   HOW TO RUN
%     - Press the green Run button (or F5).
%
%   Results (.mat + a figure) are written to simulation_output/.
...
%% ===================== USER CONFIG ======================================
heights_km       = 500:0.1:1200;   % [km] altitude sweep (vector)
Min_latitude_deg = 54 + 35/60;     % [deg] southernmost served latitude (Denmark)
Min_elevation_UE = 20;             % [deg] minimum elevation angle
inclination_deg  = 90;             % [deg] orbital inclination to evaluate
%% =======================================================================
...
out_dir  = fullfile(repo_root, 'simulation_output', ...
