...
[UE_lats_p, UE_lons_p, Total_Pop] = generate_population_based_UEs(Lat_range_deg, Lon_range_deg, people_per_ue);
...
[UE_lats_u, UE_lons_u] = generate_equal_ish_area_UEs(Lat_range_deg, Lon_range_deg, NumUEs_uniform);
