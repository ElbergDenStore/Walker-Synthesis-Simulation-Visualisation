% xvfb-run -a --server-args="-screen 0 1920x1080x24" matlab -nosplash -nodesktop -batch "run('plotting_scripts/link_budget/plot_tx_gain_vs_altitude.m')"
...
%% Output directory
out_dir = fullfile(repo_root, 'plotting_scripts', 'figures');
